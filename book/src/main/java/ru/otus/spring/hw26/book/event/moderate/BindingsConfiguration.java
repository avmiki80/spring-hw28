package ru.otus.spring.hw26.book.event.moderate;
    ...
    void init(){
        bindingServiceProperties.getBindings()
                .put(ModerateChannelConstant.FROM_MODERATE_COMMAND,
                        createConsumerProperties(ModerateChannelConstant.FROM_MODERATE_COMMAND));

        bindingServiceProperties.getBindings()
                .put(ModerateChannelConstant.TO_MODERATE_COMMAND,
                        createProducerProperties(ModerateChannelConstant.TO_MODERATE_COMMAND));
    }
