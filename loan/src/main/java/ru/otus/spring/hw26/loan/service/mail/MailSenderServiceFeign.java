...
import ru.otus.spring.hw26.loan.feign.MailSenderFeignClient;
...
public class MailSenderServiceFeign implements MailSenderService {
    ...
    public MailSenderServiceFeign(
            @Qualifier("ru.otus.spring.hw26.loan.feign.MailSenderFeignClient") MailSenderFeignClient mailSenderFeignClient) {
